...
export function StandPrestationsModal({ stand, onClose, onEditPrestation }: { stand: Stand & { prestations?: Prestation[] }; onClose: () => void; onEditPrestation?: (p: Prestation) => void }) {
