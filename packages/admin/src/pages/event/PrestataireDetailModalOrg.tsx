...
export function PrestataireDetailModal({ prestataire, evenementId, onClose }: { prestataire: Prestataire; evenementId: string; onClose: () => void }) {
  ...
  return (
    <>
      ...
      {editingPrestation && <PrestationFormOrg readOnly prest={editingPrestation} evenementId={evenementId} onSaved={() => { setEditingPrestation(null); loadPrestations() }} onGoToStands={() => setEditingPrestation(null)} canDelete />}
